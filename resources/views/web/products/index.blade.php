          ...
          <div class="product-top">
            ...
            <ul>
              <li class="dropdown head-dpdn">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">{{__('main.sortBy')}} <span class="caret"></span></a>
                      ...
                      <div class="product-item">
                        <div class="product-borde-inner">
                          <a href="{{ url("/products/show/{$product->id}") }}">
                            <img src="{{ asset("uploads/$product->img") }}" class="img img-responsive" />
                          </a>


                          <div class="product-price">
                            <a href="{{ url("/products/show/{$product->id}") }}"> {{ $product->name() }}</a><br />
                          ...
                          <form id="addToCart" action="{{url("/cart/add-cart/{$product->id}") }}" method="post" style="display: block;">
                            @csrf
