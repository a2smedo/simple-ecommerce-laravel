jQuery(document).ready(function(){
   ...
   $('.item-full').addClass('hidden');
    ...
    $(".featured").hover(function(){
        $(".featured-inner").removeClass('slideOutLeft hidden width0');
        $(".featured-inner").addClass('fadeIn width70');
    }).mouseleave(function(){
        $(".featured-inner").removeClass('slideInRight width70');
        $(".featured-inner").addClass('slideOutLeft hidden width0');
    });
